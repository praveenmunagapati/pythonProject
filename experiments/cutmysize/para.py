...
for j in tokens:
    for k in j:
        print(ord(k),end=',')
        tokenstoints.append(ord(k))
    print(end='\t')


print(tokenstoints)
print(len(tokenstoints))

for  i in tokenstoints:
    print(chr(i),end='')
